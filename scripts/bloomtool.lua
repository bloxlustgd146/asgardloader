local user do
    user = {} do
        user.name = _USER_NAME or "tempelstd"
        user.role = "OWNER"
        user.last_update = "333"
        user.debug = false
...
LPH_NO_VIRTUALIZE(function ()
    ...
    local antiaimbot do
        ...
        config.antiaimbot = {} do
            ...
            config.antiaimbot.air_exploit = menu.new_item(ui.new_checkbox, "AA", "Fake lag", "Airlag")
    ...
    local miscellaneous do
        ...
        miscellaneous = {} do
            ...
            miscellaneous.trashtalk = {} do
                ...
                local list = {
                    ['head'] = {
                        'хуевый бомж / дефенсивы ща не в моде)',
                        'Добрый день / Это компания по зачистке сочников, вы улетели.',
                        'как же ты сочно отлетел / с луасенсом играешь что ли?',
                        'ДОЛБАЕБ ЕБАННЫЙ / Я ТЕ В ЕБАЛО ХАРКНУЛ',
                        'СЛЫШЬ УЗБЕК / СЛАБО ЛИВНУТЬ С ХВХ?',
                        'АВЫХАЗВЫХАЫЗАЗВХ / И ВОТ ЭТО ИГРОК?',
                        '1 / надеюсь ты ливнешь с хвх',
                        '1 / даун',
                        '1 / АХЗХЫХВФЗЗАЗХА',
                        'слыш / там батька твоего мобилизировали',
                        'ебать ты вбайтился / 1 хачбек',
                        'че ты а? / амбассадор спектаторов',
                        'четко в жбан / прямо как в твою мать из дробовика',
                        'БАМ',
                        'Loser / why you so brainless?',
                        'u think im lucky?? / just gamesense.pub',
                        'добрый вечер',
                        'нормас я тебя?  / так чисто по башке зарядил',
                        'соси уёба / вообще не чуствую',
                        '1 / лови по шапенции'
                    },
                    ['body'] = {
                        'я твоей маме тараканов в жопу пихал / животное ебаное',
                        'ХА ЧМО ЗАЦЕНИ АЙДИШНИК / id/god',
                        'че там / не устал сдыхать?',
                        'никчемный пидорас / 1',
                        'e1 / пффф как-то слабовато',
                        'слышь пёс / по команде в спеках',
                        '1 / даун',
                        'КУДА ТЫ ТАМ ПОЛЗЕШЬ / тупая  шваль',
                        'нихуя'
                    },
                    ['taser'] = {
                        'сгорел пидорас ебаный',
                        'слышь педик / чета ты на зевсе',
                        'шлюха на зевсе / че деду?',
                        'Не ну я бы сфоткал / f12',
                        'лох на зевсе'
                    },
                    ['inferno'] = {
                        'сгорел пидорас ебаный',
                        ...
                        'АХВЗЫХАЗВАХЫХВЗА / сгорел в печи'
                    },
                    ['hegrenade'] = {
                        'взорван на хае / соси хуяку мразь',
                        'АЛЛАХ АКБАР ',
                        'как на сво / поддорван педик'
                    },
                    ['death'] = {
                        'че ты делаешь? / безмозглый x',
                        'не не не / что ты делаешь педик',
                        'бич опять убил / 5х5 на 2к евро слетаем ссаный мусор?',
                        '=АЫЗВАХВЫЗХА / ЧТО ТЫ СДЕЛАЛ',
                        'так держать / сын проститутки ебанной'
                    },
                    ['revenge'] = {
                        '1.'
                    }
