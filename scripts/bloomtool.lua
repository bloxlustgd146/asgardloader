            ...
            miscellaneous.trashtalk = {} do
                ...
                local list = {
                    ['head'] = {
                        ...
                        'я на тебя накакал / твои действия?',
                        ...
                        'добрый вечер',
                        'нормас я тебя шлёпнул / сразу видно ты с  / только эту хуйню тапнуть можно',
                    ...
                    ['taser'] = {
                        ...
                        'ты зацепер? / просто также стал тухлятиной',
                        'шлюха на зевсе / че деду?',
                        'Не ну я бы заскринил / f12',
                        '220 ВОЛЬТ ЕБАНУЛО ТЕБЯ?'
                    },
                    ['inferno'] = {
                        'сгорел пидорас ебаный',
                        ...
                        'F]DFDSFSD]F[DSFSDFS] / сгорел в аду'
                    },
                    ['hegrenade'] = {
                    ...
                    ['death'] = {
                        'what are u doing? / brainless xD',
                        'ща в жбан пропишу тебе',
                        'не не не / что ты делаешь педик',
                        'слышь педик / 1х1 сгоняем?',
                        'нихуя впн врубился сам',
                        'Слышь чурка / ты как это делаешь? / хач ебанный',
                        'знахарь ебанный / 5х5 на 2к евро слетаем ссаный мусор?',
                        'ну ахуенно / опять в сприд миссаю',
                        'сервер копеечный / ну зато у пидораса тут стреляет',
                        'F][SD[]FSD][FD[]FSD[]] / хуесосу опять повезло',
                        'фу / ублюдок что ты сделал',
